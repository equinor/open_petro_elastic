...
def residual_helmholtz_energy(delta_, tau_, diff_delta, diff_tau):
    ...
    _s2 = np.sum(_LAMBDIFIED_EXPRESSIONS[(s2, diff_delta, diff_tau)](tau_, delta_), axis=-1)
    _s3 = np.sum(_LAMBDIFIED_EXPRESSIONS[(s3, diff_delta, diff_tau)](tau_, delta_), axis=-1)
    _s4 = np.sum(_LAMBDIFIED_EXPRESSIONS[(s4, diff_delta, diff_tau)](tau_, delta_), axis=-1)
